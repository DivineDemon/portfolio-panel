...
import { appApis, type GetApiProjectsApiResponse, useDeleteApiProjectsByIdMutation } from "@/store/services/apis";
...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  const prefetchProject = () => {
    void dispatch(appApis.util.prefetch("getApiProjectsById", { id: `${project.id}` }, { ifOlderThan: 30 }));
  };
